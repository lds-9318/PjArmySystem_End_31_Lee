...
public class ArmyJDailogGUI extends JDialog implements ActionListener {
	...
	public ArmyJDailogGUI(MainTable me, String index) {
		super(me, "정보창");
		this.me = me;

//		class Mypanel extends JPanel {
//			ImageIcon icon = new ImageIcon("../images/unnamed.png");
//
...
//TextField 추가
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(Intropage.class.getResource("/images/AmyIcon.jpg")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (btnLabel.equals("등록")) {
			...
			if (dao.userUpdate(this) > 0) {
				System.out.println(dao.userUpdate(this));
